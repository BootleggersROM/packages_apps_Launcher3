...
public class HideLockComponent {
    @NonNull
    ...
    public HideLockComponent(@NonNull String packageName, @NonNull Drawable icon,
    ...
    public boolean equals(Object other) {
        if (!(other instanceof HideLockComponent)) {
            return false;
        }

        HideLockComponent otherComponent = (HideLockComponent) other;
