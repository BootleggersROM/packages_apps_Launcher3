 ...
 */
package com.android.launcher3.security.hidelock.db;
...
public class HideLockDatabaseHelper extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "hidelock_apps_db";

    private static final String TABLE_NAME = "hidelock_apps";
    ...
    @Nullable
    private static HideLockDatabaseHelper sSingleton;

    private HideLockDatabaseHelper(@NonNull Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    public static synchronized HideLockDatabaseHelper getInstance(@NonNull Context context) {
        if (sSingleton == null) {
            sSingleton = new HideLockDatabaseHelper(context);
        }
