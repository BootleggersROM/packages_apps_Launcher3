...
public class LoadHideLockComponentsTask extends AsyncTask<Void, Integer, List<HideLockComponent>> {
    @NonNull
    ...
    LoadHideLockComponentsTask(@NonNull HideLockDatabaseHelper dbHelper,
    ...
    @Override
    protected List<HideLockComponent> doInBackground(Void... voids) {
        List<HideLockComponent> list = new ArrayList<>();
        ...
        for (int i = 0; i < numPackages; i++) {
            ...
            try {
                ...
                list.add(new HideLockComponent(pkgName, icon, label, isHidden, isProtected));
    ...
    @Override
    protected void onPostExecute(List<HideLockComponent> HideLockComponents) {
        mCallback.onLoadCompleted(HideLockComponents);
    }

    interface Callback {
        void onLoadListProgress(int progress);
        void onLoadCompleted(List<HideLockComponent> result);
    }
}
